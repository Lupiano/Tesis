...
public class HEBServiceAdapter implements DataReader
{
	...
	public ArrayList<ArrayList<Operation>> clusteredOperations = new ArrayList<ArrayList<Operation>>();
	...
	
	{
		...
		for (final Iterator<List<Operation>> i = res.iterator(); i.hasNext();)
		{
			...
			List<Operation> listOp = i.next();
			ArrayList<Operation> ops = new ArrayList<Operation>(listOp);
			this.clusteredOperations.add(ops);
			
			int next = listOp.size();
			cantOp += next;
		}
	...
	public ArrayList<ArrayList<Operation>> getClusteredOperations() {
		return clusteredOperations;
	}

	@Override
	public void setClusteredOperations(ArrayList<ArrayList<Operation>> clusteredOperations) {
		// TODO Auto-generated method stub
